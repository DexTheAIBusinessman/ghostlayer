        ...
        <div className="mt-8 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
            ...
            <Link
              ...
              className="min-h-[10.5rem] rounded-[2rem] border border-yellow-300/20 bg-yellow-300/10 p-6 text-yellow-100 shadow-[0_24px_100px_rgba(0,0,0,0.25)] transition hover:scale-[1.01] hover:bg-yellow-300/15"
            >
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-gray-300">
                Reviews scans, reports, feedback, CTA clicks, and messages for admin-approved content ideas.
              </p>
            </Link>

            <Link
              href="/admin/agents/sales-conversion"
              className="rounded-[1.5rem] border border-purple-300/20 bg-purple-300/10 p-5 backdrop-blur-xl transition hover:scale-[1.01] hover:bg-purple-300/15"
            >
              ...
              <p className="mt-3 text-sm leading-6 text-gray-300">
                Reviews leads, scans, messages, reports, CTA clicks, and feedback for conversion opportunities.
              </p>
            </Link>
            ...
            >
              ...
              <Link
                ...
                className="rounded-[1.75rem] border border-cyan-300/30 bg-cyan-300/10 p-6 shadow-2xl shadow-cyan-950/20 transition hover:-translate-y-1 hover:border-cyan-200/50 hover:bg-cyan-300/[0.14]"
              >
                ...
                <p className="mt-4 text-sm leading-6 text-slate-300">
                  Reviews leads, scans, uploads, messages, reports, monitoring, activity, and business risk signals.
                </p>
              </Link>
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-lime-100/75">
              Review trust, support, privacy, billing safety, upload protection, and business readiness.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-3 text-2xl font-black">Prep</p>
            <p className="mt-3 text-sm leading-6 text-emerald-100/75">
              Review report and scan records, prioritize prep, and suggest next actions.
            </p>
          </Link>
          ...
          >
            ...
            >
              ...
              <Link
                ...
                className="min-h-[10.5rem] rounded-[2rem] border border-pink-300/20 bg-pink-300/10 p-6 text-pink-100 shadow-[0_24px_100px_rgba(0,0,0,0.25)] transition hover:scale-[1.01] hover:bg-pink-300/15"
              >
                <p className="text-xs font-bold uppercase tracking-[0.22em]">
                  Merge Client
                </p>
                <p className="mt-3 text-2xl font-black">Email</p>
                <p className="mt-3 text-sm leading-6 text-pink-100/75">
