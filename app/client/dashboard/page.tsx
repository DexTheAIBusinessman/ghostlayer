...
async function getClientReports(email: string): Promise<Report[]> {
  ...
  if (!response.ok) {
    ...
    console.error("Could not load reports:", errorText);
    return [];
  }
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#05070b] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mb-8 mt-12 grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-[1.5rem] border border-emerald-300/25 bg-emerald-300/10 p-5 backdrop-blur-xl min-h-[110px]">
