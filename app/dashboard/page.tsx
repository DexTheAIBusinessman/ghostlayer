...
export default function HomePage() {
  ...
  const stars = useMemo<Star[]>(
    () => [
      { left: '6%', top: '10%', size: 2, delay: '0s', duration: '4.5s', opacity: 0.6 },
      { left: '12%', top: '22%', size: 3, delay: '1.2s', duration: '5.5s', opacity: 0.8 },
      { left: '18%', top: '72%', size: 2, delay: '0.8s', duration: '6s', opacity: 0.55 },
      { left: '24%', top: '42%', size: 2, delay: '2.2s', duration: '4.8s', opacity: 0.7 },
      { left: '31%', top: '14%', size: 3, delay: '1.8s', duration: '5.8s', opacity: 0.8 },
      { left: '37%', top: '60%', size: 2, delay: '0.5s', duration: '6.2s', opacity: 0.6 },
      { left: '43%', top: '28%', size: 2, delay: '2.8s', duration: '5.3s', opacity: 0.72 },
      { left: '49%', top: '82%', size: 3, delay: '1.1s', duration: '6.5s', opacity: 0.8 },
      { left: '56%', top: '16%', size: 2, delay: '2.6s', duration: '4.7s', opacity: 0.6 },
      { left: '62%', top: '48%', size: 3, delay: '1.6s', duration: '5.9s', opacity: 0.82 },
      { left: '68%', top: '74%', size: 2, delay: '0.3s', duration: '6.6s', opacity: 0.62 },
      { left: '74%', top: '24%', size: 2, delay: '2.1s', duration: '5.1s', opacity: 0.7 },
      { left: '79%', top: '58%', size: 3, delay: '1.3s', duration: '5.7s', opacity: 0.84 },
      { left: '85%', top: '12%', size: 2, delay: '2.9s', duration: '4.9s', opacity: 0.58 },
      { left: '89%', top: '36%', size: 2, delay: '0.9s', duration: '6.1s', opacity: 0.7 },
      { left: '93%', top: '68%', size: 3, delay: '2.4s', duration: '5.6s', opacity: 0.82 },
      { left: '10%', top: '88%', size: 2, delay: '1.4s', duration: '6.8s', opacity: 0.54 },
      { left: '27%', top: '90%', size: 2, delay: '2s', duration: '5.2s', opacity: 0.65 },
      { left: '52%', top: '6%', size: 2, delay: '0.7s', duration: '6.4s', opacity: 0.56 },
      { left: '71%', top: '92%', size: 2, delay: '2.5s', duration: '5.4s', opacity: 0.66 },
    ],
    []
  );
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-black text-white">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.16),transparent_30%),radial-gradient(circle_at_top_right,rgba(168,85,247,0.14),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(6,182,212,0.10),transparent_28%),radial-gradient(circle_at_center,rgba(255,255,255,0.03),transparent_40%)]" />
        <div className="absolute left-[-10%] top-[-10%] h-[34rem] w-[34rem] rounded-full bg-cyan-400/10 blur-3xl animate-float-slow" />
        <div className="absolute right-[-12%] top-[10%] h-[30rem] w-[30rem] rounded-full bg-fuchsia-500/10 blur-3xl animate-float-slower" />
        <div className="absolute bottom-[-12%] left-[24%] h-[28rem] w-[28rem] rounded-full bg-blue-500/10 blur-3xl animate-float-slow" />
      ...
      <header className="relative z-20 border-b border-white/10 bg-black/60 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-5 sm:px-6 md:px-8 lg:px-10">
          <Link
            href="/"
            className="inline-block text-[1.2rem] font-bold tracking-[0.16em] text-white [text-shadow:0_0_8px_rgba(255,255,255,1),0_0_18px_rgba(255,255,255,0.96),0_0_34px_rgba(96,165,250,0.95),0_0_58px_rgba(59,130,246,0.9),0_0_92px_rgba(147,51,234,0.76)] sm:text-[1.35rem]"
          >
            GHOSTLAYER
          </Link>
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <Link
              href="/dashboard"
              className="rounded-xl border border-cyan-400/30 bg-cyan-400/5 px-3 py-2 text-xs font-semibold text-cyan-300 transition hover:bg-cyan-400/10 hover:text-white"
            >
              Dashboard
            </Link>
          </div>
      ...
      <section className="relative z-10 overflow-hidden px-4 pb-16 pt-10 sm:px-6 sm:pb-20 md:px-8 md:pt-14 lg:px-10 lg:pb-24 xl:px-12">
        <div className="mx-auto max-w-7xl">
          <div className="grid items-start gap-10 xl:grid-cols-[minmax(0,1.08fr)_minmax(360px,460px)] xl:gap-12 2xl:grid-cols-[minmax(0,1.12fr)_minmax(380px,480px)]">
            ...
            <div className="w-full xl:-mt-4 2xl:-mt-8">
              <div className="rounded-[2rem] border border-cyan-400/25 bg-white/5 p-4 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur-sm sm:p-5">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="rounded-3xl border border-cyan-400/20 bg-cyan-400/5 p-5">
                    ...
                    <p className="mt-3 text-5xl font-bold text-white">68/100</p>
                  ...
                  <div className="rounded-3xl border border-red-500/25 bg-red-500/10 p-5">
                    ...
                    <p className="mt-3 text-5xl font-bold text-white">$3,247/mo</p>
                    <p className="mt-3 text-sm leading-7 text-gray-300">
